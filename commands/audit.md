...
4. **If the script exits with code 0** (audit passed):
   ...
   5. Re-run /claude-c-suite:audit to confirm post-bump consistency
...
5. **If the script exits with a non-zero code** (audit failed):
   ...
   - Conclude with: "Fix these and run `/claude-c-suite:audit` again. The plugin is **not** ready to release."
