...
**Keep in English**: code blocks, file paths, CLI commands, technical identifiers, issue titles quoted verbatim, and the structural section headings in the output format templates below (e.g., `## Developer Experience Summary`, table column names) — this keeps the output grep-able and tool-parseable.
