...
## The C-Suite cross-reference structure
...
5. **Deliver the decision**: Provide a clear, opinionated executive answer:
   ...
   - If PhD Panel commands have been run in this session, incorporate their findings where they strengthen the decision
