...
Claude C-Suite Plugin is a collection of markdown command files that
...
- **GitHub Security Advisories**: https://github.com/JFK/claude-c-suite-plugin/security/advisories/new
