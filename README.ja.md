...
- **CEO** — 相関図の上に立つメタ���イヤー。ユーザーのニーズを分析し、11ロールから最も適切な3つのCxO視点を選定。それぞれの観点で分析した上で、合意点・対立点・トレードオフを統合して経営判断を導出する。専門知識ではなく**どの専門家に聞くべきか**を判断する。*"The right 3 perspectives beat all 11 spread thin（適切な3つの視点は、11全部を薄く見るより強い）"*
